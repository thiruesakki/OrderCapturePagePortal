...
public class TCUserProfileObject  { 
		...
		private List<String> jobTitleID=new ArrayList<String> ();
		private List<String>  OrganizationID=new ArrayList<String> ();
		...
		public List<String> getJobTitleID() {
			return jobTitleID;
		}

		public void setJobTitleID(List<String> jobTitleID) {
		...
		public String toString() {
			return "TEUserProfileObject [id=" + id + ", email=" + email
					+ ", password=" + password + ", firstName=" + firstName
					+ ", lastname=" + lastname + ", confirmedStatus="
					+ confirmedStatus + ", approvedStatus=" + approvedStatus
					+ ", activeStatus=" + activeStatus + ", phone1=" + phone1
					+ ", phone2=" + phone2 + ", address=" + address + ", city="
					+ city + ", state=" + state + ", country=" + country
					+ ", lang=" + lang + ", remarks=" + remarks + ", timezone="
					+ timezone + ", firstaccess=" + firstaccess
					+ ", lastaccess=" + lastaccess + ", lastlogin=" + lastlogin
					+ ", currentlogin=" + currentlogin + ", lastip=" + lastip
					+ ", secret=" + secret + ", picture=" + picture + ", url="
					+ url + ", description=" + description
					+ ", years_of_experience=" + years_of_experience
					+ ", area_of_speciality=" + area_of_speciality
					+ ", interest_in_communication="
					+ interest_in_communication + ", bays_in_shop="
					+ bays_in_shop + ", brake_jobs_in_a_month="
					+ brake_jobs_in_a_month + ", list_in_find_a_shop="
					+ list_in_find_a_shop
					+ ", currently_using_raybestos_products="
					+ currently_using_raybestos_products + ", mailformat="
					+ mailformat + ", maildisplay=" + maildisplay
					+ ", htmleditor=" + htmleditor + ", autosubscribe="
					+ autosubscribe + ", timemodified=" + timemodified
					+ ", nickname=" + nickname + ", keepShopPrivate="
					+ keepShopPrivate + ", KeepEmployeePrivate="
					+ KeepEmployeePrivate + ", iscustomer=" + iscustomer
					+ ", verificationlinksenttime=" + verificationlinksenttime
					+ ", referedby=" + referedby + ", isFirstAccess="
					+ isFirstAccess + ", jobTitleID=" + jobTitleID
					+ ", OrganizationID=" + OrganizationID + "]";
		}
