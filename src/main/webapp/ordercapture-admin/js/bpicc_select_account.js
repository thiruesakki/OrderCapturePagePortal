...
//				 
				 var xml = [
							           {
							        	      ...
							        	      "PARTY_SITE_ID": 1087,
							        	      "DEFAULT_DC": null,
							        	      "ACCOUNT_NAME": "World of Business",
							        	      "LOCATION": "New York",
							        	      "STATE": "NY",
							        	      "POSTAL_CODE": 10299,
							        	      "WAREHOUSE_ID": null
				 ...
				 console.log("ship to code"+ship_to_code);
					var orgID= getCookie("selected_org_id");
//					var shipToAddress = 4946;
					console.log("calling from common to ship address");
...
//						});  
	...
	{
		console.log("Inside fn ProcessGetSingleAccountAddressForShipTo");
		console.log('Xml data'+JSON.stringify(xml));
